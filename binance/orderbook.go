...
func (ob *PerpOrderBook) tryApplySnapshot() error {
...
func (ob *PerpOrderBook) applyEvent(event *perp.WsDepthEvent) {
...
var _ exchanges.LocalOrderBook = (*PerpOrderBook)(nil)
