...
当前 funding snapshot providers：Binance Perp、Aster Perp、OKX Swap、
Hyperliquid Perp、Lighter、Nado、EdgeX、GRVT、Backpack。Bybit Linear、Bitget
Perp、StandX 暴露的是由 venue funding-history 支撑的 latest-known snapshot。策略在把
mark/index prices 或 funding interval 用于 sizing/execution 前，应自行校验这些字段非零。
