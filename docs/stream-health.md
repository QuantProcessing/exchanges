...
`account` trading account runtimes expose copyable health snapshots for account
runtime streams. This is intended for monitoring, alerts, and SDK-user preflight
checks after `Start`.
...
| `stopped` | `Close` stopped the runtime. |
