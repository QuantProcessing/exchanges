...
type ExchangeInfo struct {
	...
	ContractList []Contract `json:"contractList"` // for perp
	SymbolList   []Symbol   `json:"symbolList"`   // for spot
...
type Symbol struct {
	...
	MarketOrderPriceRatio    string `json:"marketOrderPriceRatio"`
	MarketBuyLimitSize       string `json:"marketBuyLimitSize"`
	MarketSellLimitSize      string `json:"marketSellLimitSize"`
	MarketFallbackPriceRatio string `json:"marketFallbackPriceRatio"`
	EnableTrade              bool   `json:"enableTrade"`
	EnableDisplay            bool   `json:"enableDisplay"`
	IsSupportTracing         bool   `json:"isSupportTracing"`
	IsSupportPlanMarket      bool   `json:"isSupportPlanMarket"`
	DisplayDigitMerge        string `json:"displayDigitMerge"`
	...
	ExtraConfig              struct {
		...
		SymbolSort  string `json:"symbolSort"`
	} `json:"extraConfig"`
	PlaceConfig struct {
		ServerCalPlace     string `json:"serverCalPlace"`
		DelegatePricePlace string `json:"delegatePricePlace"`
		VolumePlace        string `json:"volumePlace"`
		PricePlace         string `json:"pricePlace"`
		CapitalRatePlace   string `json:"capitalRatePlace"`
		TransferInOutPlace string `json:"transferInOutPlace"`
		PropertyPlace      string `json:"propertyPlace"`
		PropertyHighPlace  string `json:"propertyHighPlace"`
		BaseCoinPlace      string `json:"baseCoinPlace"`
	} `json:"placeConfig"`
}
