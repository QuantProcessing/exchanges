...
func NewSwapAdapter(_ context.Context, opts Options) (*Adapter, error) {
	...
	return &Adapter{provider: provider, data: newDataClient("okx-swap-data", provider, client), exec: newExecutionClient(opts.AccountID, provider, client, "SWAP", "cross", opts.APIKey, opts.SecretKey, opts.Passphrase), fundingRates: true}, nil
}
