...
import (
	...
	spotsdk "github.com/QuantProcessing/exchanges/sdk/binance/spot"
...
func TestSpotWatchOrdersAndFillsShareSingleNativeHandler(t *testing.T) {
	wsAPI := &spotsdk.WsAPIClient{Conn: &websocket.Conn{}}
	wsAccount := spotsdk.NewWsAccountClient(wsAPI, "", "")
	setUnexportedBool(t, wsAccount, "subscribed", true)
	...
	require.Equal(t, 1, callbackCount(wsAccount, "executionReportCallbacks"))
	...
	invokeCallback(t, wsAccount, "executionReportCallbacks", 0, report)
...
func setUnexportedBool(t *testing.T, target any, field string, value bool) {
	t.Helper()
