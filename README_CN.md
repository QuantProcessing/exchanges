...
1. [Getting Started](./docs/getting-started.md)：安装、拉行情、写策略、跑回测、
   组装 live node。
2. [Module Guide](./docs/module-guide.md)：每个包的职责，以及什么时候该 import
   哪一层。
3. [Runtime Flow](./docs/runtime-flow.md)：行情、订单、成交、风控、组合和
   reconciliation 如何流动。
4. [Reliable Quant Program Guide](./docs/guides/reliable-quant-program.md)：写可靠
   量化程序的实践清单。
5. [Documentation Index](./docs/README.md)：完整文档站地图。
...
详见 [Project Architecture](./docs/architecture.md) 和
...
- [Strategy Authoring](./docs/guides/strategy-authoring.md)
- [Backtesting](./docs/guides/backtesting.md)
